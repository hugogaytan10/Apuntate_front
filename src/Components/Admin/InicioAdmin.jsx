            ...
            <div className='flex flex-wrap w-full justify-center mt-4 gap-4'>
                ...
                <div className='contenedor-empleo relative flex flex-wrap md:w-1/4'>
                    ...
                    <div className='flex justify-around w-full'>
                        <NavLink className='bg-gris-oscuro text-gray-50 m-auto w-1/4 p-1 rounded-sm text-base text-center' to='/postuladosAdmin'>Postulados</NavLink>
                        <button className='bg-blue-600 text-gray-50 m-auto w-1/4 p-1 rounded-sm text-base text-center'>Editar</button>
                        <button className='bg-red-500 text-gray-50 m-auto w-1/4 p-1 rounded-sm text-base text-center'>Eliminar</button>
                    </div>
                </div>

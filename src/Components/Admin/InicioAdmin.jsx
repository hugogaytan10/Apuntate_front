    ...
    return (
        <div className='block min-h-screen w-full bg-fondo '>
            ...
            <div className='flex flex-wrap w-full justify-center mt-4 gap-4'>

                {
                    trabajos.map((trabajo, index) => {
                        return (
                            <div key={`empleo_${index}`} className='contenedor-empleo relative flex flex-wrap md:w-1/3 text-gray-600'>
                                <span className='franja-lateral'></span>
                                <p className='block w-full ml-4 font-bold text-lg'>{trabajo.Titulo}</p>
                                ...
                                <div className='flex justify-around w-full'>
                                    <NavLink className='bg-gris-oscuro text-gray-50 m-auto w-1/3 p-1 rounded-sm text-base text-center' to={`/postuladosAdmin/${trabajo.Id}`}>Postulados</NavLink>
                                    <button
                                        onClick={() => {
                        ...
                        >
                            {({
                                ...
                                <form
                                    ...
                                    {errors.contrato && touched.contrato && <ErrorMessage name='contrato' component="div" className='error' />}
                                    <div className="form-group">
                                        <select
                                            className='bg-white'
                                            name="modalidad"
                                    ...
                                    {errors.modalidad && touched.modalidad && <ErrorMessage name='modalidad' component="div" className='error' />}
            ...
            <dialog id="my_modal_3" className="modal">
                <div className="modal-box bg-white text-gray-600">
                    <h3 className="font-bold text-lg">Eliminar empleo <strong> {trabajo.Tiempo} </strong></h3>

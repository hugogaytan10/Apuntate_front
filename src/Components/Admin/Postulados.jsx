            ...
            <div className='flex flex-wrap w-full justify-center mt-4 gap-4'>
                <div className='contenedor-empleo relative flex flex-wrap md:w-4/12'>
                    ...
                    <div className='flex justify-around w-full'>
                        <NavLink className='bg-primario rounded-md btn text-gray-50 m-auto w-5/12 p-1 rounded-sm text-base text-center' to='/detallesTrabajo'>Ver postulante</NavLink>

...
export const TipoRegistro = () => {
    ...
    return (
        <div className='min-h-screen bg-primario relative'>
            ...
            <h3 className='relative text-white text-2xl text-center top-14'>¿Cómo deseas registrarte?</h3>
            <div
                onClick={() => { navigate('/RegistroCompania') }}
                className='h-72 w-72 bg-white rounded-full absolute top-40 left-1/2 -translate-x-1/2 flex flex-wrap flex-col justify-center items-center'>
                <img src={company} alt="compañia" />
                <p className='text-2xl font-bold text-primario'>COMPAÑIA</p>
            </div>
            <div
                onClick={() => { navigate('/RegistroUsuario') }}
                className='h-72 w-72 bg-white rounded-full absolute top-2/4 left-1/2 -translate-x-1/2 flex flex-wrap flex-col justify-center items-center'>

...
import {
  ...
  empresaSchema,
  empresaTresSchema,
} from "../EsquemasValidacion/Empresa";
...
export const RegistroCompania = () => {
  ...
  const insertarUsuario = async (
    ...
    fetch(
      "https://apuntateback-production.up.railway.app/api/empresa/agregar",
      {
        method: "POST",
        mode: "cors",
        headers: {
    ...
    <div className="bg-fondo min-h-screen">
          ...
          >
            ...
            >
              ...
              {errors.giro && touched.giro && (
                <ErrorMessage name="giro" component="div" className="error" />
              )}
              <div className="form-group">
                <input
                  type="text"
      ...
      >
        {({
          ...
          <div
            id="divPasoDos"
            className="w-11/12 m-auto bg-white mt-10 transition-all opacity-0 md:w-2/4"
          >
